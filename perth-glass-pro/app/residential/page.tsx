...
export default function ResidentialPage() {
    ...
    return (
        <>
            <main className="min-h-screen bg-brand-snow text-brand-slate">
                {/* HERO */}
                    ...
                    <div className="max-w-5xl mx-auto px-4 text-center">
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4">
                            <button
                                ...
                                className="w-full sm:w-auto inline-flex items-center justify-center gap-3 bg-action-gold text-brand-navy font-bold text-base sm:text-lg px-8 py-4 rounded-full hover:bg-action-gold/90 transition-colors cursor-pointer min-h-[48px] shadow-md"
                            >
                                Get Instant Quote
                ...
                <section className="py-16 bg-white border-t border-slate-100">
                    <div className="max-w-5xl mx-auto px-4">
                        ...
                        {/* Complete Home Package Advantage Banner */}
                        <div className="mt-10 p-6 sm:p-8 rounded-2xl bg-gradient-to-r from-brand-navy to-slate-900 text-white flex flex-col md:flex-row items-center justify-between gap-6 shadow-md">
                            ...
                            <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto flex-shrink-0">
                                <button
                                    onClick={() => setIsModalOpen(true)}
                                    className="inline-flex items-center justify-center gap-2 bg-action-gold text-brand-navy font-bold px-6 py-3 rounded-full text-sm hover:bg-action-gold/90 transition-all min-h-[44px] cursor-pointer"
                                >
                ...
                <section className="py-16 bg-brand-navy text-white">
                    <div className="max-w-3xl mx-auto px-4 text-center">
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                            <button
                                onClick={() => setIsModalOpen(true)}
                                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-action-gold text-brand-navy font-bold px-8 py-4 rounded-full text-base sm:text-lg hover:bg-action-gold/90 transition-colors min-h-[48px] cursor-pointer shadow-md"
                            >
                                Get Your Free Quote
