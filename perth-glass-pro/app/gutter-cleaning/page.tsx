    ...
    return (
        <>
            ...
            <section className="relative min-h-screen flex flex-col overflow-hidden bg-cover bg-center
                 bg-[linear-gradient(160deg,rgba(7,7,126,0.3)_0%,rgba(5,5,80,0.5)_60%,rgba(3,3,50,0.9)_100%),url('https://res.cloudinary.com/dr8tjrszy/image/upload/f_auto,q_auto,w_800/v1777441115/WhatsApp_Image_2026-04-27_at_12.43.50_PM_1_je8jsa.jpg')]"
            >
                {/* Decorative circles */}
            ...
            <section className="max-w-7xl mx-auto px-5 py-16 bg-white">
                <BeforeAfterSlider
                    beforeImage="https://res.cloudinary.com/dr8tjrszy/image/upload/f_auto,q_auto,w_800/v1777441113/WhatsApp_Image_2026-04-27_at_12.43.46_PM_cvkw1l.jpg"
                    afterImage="https://res.cloudinary.com/dr8tjrszy/image/upload/f_auto,q_auto,w_800/v1777441114/WhatsApp_Image_2026-04-27_at_12.43.48_PM_yxfcd8.jpg"
                    initial={50}
                />
            </section>
