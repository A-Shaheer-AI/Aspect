    ...
    return (
        <>
            ...
            <div className="min-h-screen bg-brand-snow">
                ...
                {/* Hero */}
                <header className="bg-brand-navy text-white pt-32 pb-20 px-4 text-center">
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <div className="p-6 flex flex-col flex-1">
                                            ...
                                            {/* Title */}
                                            <h2 className="text-lg font-bold text-brand-navy mb-3 leading-snug group-hover:text-action-gold transition-colors line-clamp-3">
                                                {cs.title}
                                            </h2>
