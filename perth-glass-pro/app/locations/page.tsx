                ...
                <div className="max-w-md mx-auto mb-8 sm:mb-12">
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="w-full pl-12 pr-4 py-3.5 sm:py-4 rounded-full border border-slate-200 bg-white shadow-sm focus:ring-2 focus:ring-action-gold focus:outline-none text-base sm:text-lg"
                        />
                    </div>
                </div>
                        ...
                        <div className="grid grid-cols-2 gap-1.5 sm:gap-2">
                            {filteredSuburbs.North.map((suburb) => (
                                <Link
                                    ...
                                    className="flex items-center gap-1.5 sm:gap-2 px-2.5 sm:px-3 py-2 rounded-lg hover:bg-slate-50 text-brand-slate hover:text-brand-navy transition-colors text-xs sm:text-sm min-h-[36px]"
                                >
                                    <MapPin className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-action-gold flex-shrink-0" />
