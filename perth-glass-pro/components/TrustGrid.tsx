            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center mb-10">
                    <div className="inline-flex flex-wrap items-center justify-center gap-2.5 mb-4">
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="inline-flex items-center gap-2 bg-green-50 hover:bg-green-100 text-green-700 border border-green-200/60 px-3.5 py-1.5 rounded-full text-xs sm:text-sm font-semibold transition-colors"
                        >
                            ...
                            Google: <strong>{gmb.rating}★</strong> ({gmb.reviewCount})
                        </a>
                        <a
                            href={BUSINESS.trustpilot}
                            target="_blank"
                            rel="noopener noreferrer"
                            className="inline-flex items-center gap-2 bg-[#00b67a]/10 hover:bg-[#00b67a]/20 text-[#005128] border border-[#00b67a]/30 px-3.5 py-1.5 rounded-full text-xs sm:text-sm font-semibold transition-colors"
                        >
                            <span className="inline-flex items-center justify-center w-4 h-4 bg-[#00b67a] text-white text-[10px] font-bold rounded-sm">★</span>
                            Trustpilot: <strong>5.0★</strong> (Verified)
                        </a>
                    </div>
                    ...
                    <div className="flex items-center justify-center gap-4">
                        ...
                        <span className="text-gray-500">Verified Client Ratings</span>
                    </div>
                </div>
                    ...
                    {reviews.slice(0, 6).map((review, index) => {
                        ...
                        return (
                            <motion.div
                                ...
                                className="bg-white rounded-2xl p-6 shadow-lg shadow-gray-200/50 border border-slate-100 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col justify-between"
                            >
                                <div>
                                    <div className="flex items-start gap-3 mb-4">
                                        <div className={`w-12 h-12 rounded-full ${isTrustpilot ? 'bg-[#00b67a]' : getAvatarColor(review.name)} flex items-center justify-center text-white font-bold text-lg flex-shrink-0`}>
                                            {isTrustpilot ? '★' : getInitials(review.name)}
                                        </div>
                                        <div className="flex-1 min-w-0">
                                            <div className="flex items-center gap-2">
                                                <h4 className="font-semibold text-brand-navy truncate">{review.name}</h4>
                                                {isTrustpilot && (
                                                    <span className="bg-[#00b67a]/15 text-[#005128] text-[10px] font-bold px-2 py-0.5 rounded-full uppercase tracking-wider">
                                                        Verified
                                                    </span>
                                                )}
                                            </div>
                                    ...
                                    <div className="flex items-center gap-3 mb-3">
                                        <div className="flex gap-0.5">
                                            {[1, 2, 3, 4, 5].map((star) => (
                                                <Star key={star} className={`w-4 h-4 ${isTrustpilot ? 'fill-[#00b67a] text-[#00b67a]' : 'fill-yellow-400 text-yellow-400'}`} />
                                            ))}
                                        </div>
                                ...
                                <div className="mt-4 pt-4 border-t border-gray-100 flex items-center justify-between">
                                    {isTrustpilot ? (
                                        <>
                                            <div className="flex items-center gap-1.5 text-xs font-semibold text-[#00b67a]">
                                                <span className="inline-flex items-center justify-center w-3.5 h-3.5 bg-[#00b67a] text-white text-[9px] font-bold rounded-sm">★</span>
                                            ...
                                            <a
                                                ...
                                                target="_blank"
                                                rel="noopener noreferrer"
                                                className="text-xs font-medium text-gray-400 hover:text-brand-navy transition-colors underline decoration-dotted"
                                            >
                                                Verify review ↗
                                            </a>
                                        </>
                    ...
                    <div className="flex gap-4" style={{ width: 'max-content' }}>
                        {reviews.map((review) => {
                            ...
                            return (
                                <div
                                    key={review.id}
                                    className="w-[320px] flex-shrink-0 bg-white rounded-2xl p-5 shadow-lg shadow-gray-200/50 border border-slate-100 flex flex-col justify-between"
                                >
                                    <div>
                                        <div className="flex items-start gap-3 mb-3">
                                            <div className={`w-10 h-10 rounded-full ${isTrustpilot ? 'bg-[#00b67a]' : getAvatarColor(review.name)} flex items-center justify-center text-white font-bold text-sm flex-shrink-0`}>
                                                {isTrustpilot ? '★' : getInitials(review.name)}
                                            </div>
                                            <div className="flex-1 min-w-0">
                                                <div className="flex items-center gap-1.5">
                                                    ...
                                                    {isTrustpilot && (
                                                        <span className="bg-[#00b67a]/15 text-[#005128] text-[9px] font-bold px-1.5 py-0.5 rounded-full uppercase">
                                                            Verified
                                                        </span>
                                                    )}
                                                </div>
                                        ...
                                        <div className="flex items-center gap-2 mb-2">
                                            <div className="flex gap-0.5">
                                                {[1, 2, 3, 4, 5].map((star) => (
                                                    <Star key={star} className={`w-3.5 h-3.5 ${isTrustpilot ? 'fill-[#00b67a] text-[#00b67a]' : 'fill-yellow-400 text-yellow-400'}`} />
                                                ))}
                                            </div>
                                        ...
                                        {isTrustpilot ? (
                                            <>
                                                ...
                                                <a
                                                    ...
                                                    target="_blank"
                                                    rel="noopener noreferrer"
                                                    className="text-xs font-medium text-gray-400 hover:text-brand-navy underline decoration-dotted"
                                                >
                                                    Verify ↗
                                                </a>
                                            </>
                ...
                <div className="flex flex-wrap items-center justify-center gap-4 mt-10">
                    <Link
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center gap-2 bg-brand-navy text-white px-7 py-3 rounded-full font-semibold hover:bg-brand-navy/90 transition-colors shadow-lg shadow-brand-navy/20 text-sm sm:text-base"
                    >
                    ...
                    <Link
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center gap-2 bg-[#00b67a] text-white px-7 py-3 rounded-full font-semibold hover:bg-[#009b67] transition-colors shadow-lg shadow-[#00b67a]/20 text-sm sm:text-base"
                    >
                        <span className="inline-flex items-center justify-center w-5 h-5 bg-white text-[#00b67a] text-xs font-bold rounded-sm">★</span>
                        View on Trustpilot
                    </Link>
                </div>
            </div>
