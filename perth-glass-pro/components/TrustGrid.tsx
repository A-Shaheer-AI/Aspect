...
export const reviews: Review[] = [
    ...
    },
    {
        ...
        rating: 5,
        date: "3 weeks ago",
        tag: "Punctuality, Quality, Value",
        badge: "NEW",
        service: "2-Storey Windows, Solar Panel Wash & Gutter Cleaning",
        content: "Booked Aspect for their full exterior package — 2-storey windows inside & out, rooftop solar panel wash, and gutter cleaning. Fazal and his team did a phenomenal job. Our solar inverter showed an immediate efficiency boost after the pure water wash, and the upstairs glass is completely streak-free. Incredible value having everything done seamlessly in one visit!",
        source: "google",
        avatarColor: "bg-[#1E88E5]",
    },
    {
        id: 4,
        name: "Mandy Thompson",
