...
export default function ContactSection() {
    ...
    const gmb_url = "https://g.page/your-business";
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-2 gap-3 sm:hidden">
                    ...
                    >
                        ...
                        <p className="text-brand-slate text-xs mt-1">04XX XXX XXX</p>
                    </a>
                    ...
                    >
                        ...
                        <p className="text-brand-slate text-xs mt-1">hello@aspect.com.au</p>
                    </a>
                ...
                <div className="hidden sm:grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    >
                        ...
                        <p className="text-brand-slate">04XX XXX XXX</p>
                    </a>
                    ...
                    >
                        ...
                        <p className="text-brand-slate">hello@aspect.com.au</p>
                    </a>
