        ...
        <section className="bg-brand-navy text-white py-16">
            <div className="max-w-3xl mx-auto px-4 text-center">
                ...
                <div className="flex flex-wrap items-center justify-center gap-4 mb-6">
                    <Link href="/pricing" className="inline-flex items-center gap-2 bg-action-gold text-brand-navy font-bold px-8 py-4 rounded-full text-base sm:text-lg hover:bg-action-gold/90 transition-all shadow-md">
                        <span>View Pricing Guide</span> <ArrowRight className="w-5 h-5" />
                    </Link>
                ...
                <div className="flex items-center justify-center gap-4 sm:gap-6 text-xs sm:text-sm text-brand-water/70">
                    <a href="tel:0426996192" className="hover:text-action-gold transition-colors underline underline-offset-4 decoration-action-gold/50">
                        Call 0426 996 192
                    </a>
                    <span>&bull;</span>
